                                        ...
                                        <div class="flex-grow-1 overflow-hidden ms-3">
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                <h4 class="fs-4 flex-grow-1 mb-0"><span
                                                        class="counter-value" data-target="825">0</span>
                                                </h4>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                <h4 class="fs-4 flex-grow-1 mb-0"><span
                                                        class="counter-value" data-target="7522">0</span>
                                                </h4>
                                ...
                                <div class="card-body">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1 overflow-hidden ms-3">
                                            ...
                                            <div class="d-flex align-items-center mb-3">
                                                <h4 class="fs-4 flex-grow-1 mb-0"><span
                                                        class="counter-value" data-target="168">0</span>h
                ...
                <div class="col-xl-7">
                    <div class="card card-height-100">
                        <div class="card-header d-flex align-items-center">
                            ...
                            <div class="flex-shrink-0">
                                <a href="javascript:void(0);"
                                    class="btn btn-soft-info btn-sm shadow-none">Export Report</a>
                            </div>
                        </div><!-- end cardheader -->
                        <div class="card-body">
                                ...
                                <table class="table table-nowrap table-centered align-middle">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="progress progress-sm bg-primary-subtle flex-grow-1"
                                                        style="width: 68%;">
                                            ...
                                            <td><span
                                                    class="badge bg-warning-subtle text-warning">Inprogress</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td><span
                                                    class="badge bg-danger-subtle text-danger">Pending</span>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="progress flex-grow-1 progress-sm bg-primary-subtle"
                                                        style="width: 68%;">
                                                        <div class="progress-bar bg-primary rounded"
                            ...
                            <div class="align-items-center mt-xl-3 mt-4 justify-content-between d-flex">
                                <div class="flex-shrink-0">
                                    <div class="text-muted">Showing <span class="fw-semibold">5</span> of
                                ...
                                <table class="table table-borderless table-nowrap align-middle mb-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="mb-0">110h : <span
                                                        class="text-muted">150h</span>
                                                </h6>
                                            </td>
                                            <td>
                                                258
                                            ...
                                            <td style="width:5%;">
                                                <div id="radialBar_chart_1" data-colors='["--vz-primary"]'
                                                    data-chart-series="50" class="apex-charts"
                                                    dir="ltr"></div>
                                            </td>
                                        </tr><!-- end tr -->
                                        <tr>
                                            ...
                                            <td>
                                                <h6 class="mb-0">83h : <span
                                                        class="text-muted">150h</span></h6>
                                            </td>
                                            <td>
                                                105
                                            </td>
                                            <td>
                                                <div id="radialBar_chart_2" data-colors='["--vz-primary"]'
                                                    data-chart-series="45" class="apex-charts"
                                                    dir="ltr"></div>
                                            </td>
                                        </tr><!-- end tr -->
                                        <tr>
                                            ...
                                            <td>
                                                <div id="radialBar_chart_3" data-colors='["--vz-primary"]'
                                                    data-chart-series="75" class="apex-charts"
                                                    dir="ltr"></div>
                                            </td>
                                        </tr><!-- end tr -->
                                        <tr>
                                            ...
                                            <td>
                                                <div id="radialBar_chart_4" data-colors='["--vz-warning"]'
                                                    data-chart-series="25" class="apex-charts"
                                                    dir="ltr"></div>
                                            </td>
                                        </tr><!-- end tr -->
                                        <tr>
                                            ...
                                            <td>
                                                <div id="radialBar_chart_5" data-colors='["--vz-primary"]'
                                                    data-chart-series="60" class="apex-charts"
                                                    dir="ltr"></div>
                                            </td>
                                        </tr><!-- end tr -->
                                        <tr>
                                            ...
                                            <td>
                                                <div id="radialBar_chart_6" data-colors='["--vz-success"]'
                                                    data-chart-series="85" class="apex-charts"
                                                    dir="ltr"></div>
                                            </td>
                                        </tr><!-- end tr -->
                                        <tr>
                                            ...
                                            <td>
                                                <div id="radialBar_chart_7" data-colors='["--vz-primary"]'
                                                    data-chart-series="70" class="apex-charts"
                                                    dir="ltr"></div>
                                            </td>
                                        </tr><!-- end tr -->
                                    </tbody><!-- end tbody -->
                                                    ...
                                                    <div class="ctext-wrap">
                                                        <div class="ctext-wrap-content">
                                                            <p class="mb-0 ctext-content">Hey, I'm going to
                                                                meet a
                                                                friend of mine at the department store. I have
                                                                to
                ...
                <div class="col-xxl-4 col-lg-6">
                    <div class="card card-height-100">
                        <div class="card-header align-items-center d-flex">
                            ...
                            <div class="flex-shrink-0">
                                <div class="dropdown card-header-dropdown">
                                    <a class="dropdown-btn text-muted" href="#"
                                        data-bs-toggle="dropdown" aria-haspopup="true"
                                        aria-expanded="false">
                                ...
                                <div class="d-flex justify-content-center align-items-center mb-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-success fw-medium mb-0">
                                            <span
                                                class="badge bg-success-subtle text-success p-1 rounded-circle"><i
