            ...
            <div class="dropdown ms-sm-3 header-item topbar-user">
                <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                    ...
                    <span class="d-flex align-items-center">
                            ...
                            <div class="profile-thumb" alt="User Thumb" style="background-color: {{ auth()->user()->random_color }}; width: 50px; height: 50px; border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: 18px;">
                                {{ auth()->user()->initials }}
                            </div>
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="javascript:void(0)" onclick="event.preventDefault();
                            ...
                            data-key="t-logout">Deconnexion</span></a>
