...
<head>
    ...
    <meta charset="utf-8" />
    <title>KBG PHARMA | Connexion</title>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mt-sm-5 mb-4 text-white-50">
                            ...
                            <p class="mt-3 fs-15 fw-medium">Connexion à KBG PHARMA</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                        ...
                        <div class="card mt-4">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    <h5 class="text-primary">Bienvenue à nouveau !</h5>
                                    <p class="text-muted">Se connecter pour continuer à KBG PHARMA.</p>
                                </div>
                                <div class="p-2 mt-4">
                ...
                <div class="col-lg-12">
                    <div class="text-center">
                        <p class="mb-0 text-muted">&copy;
                            ...
                            </script> KBG PHARMA <i class="mdi mdi-heart text-danger"></i> by Owr
                            Digi
                        </p>
                    </div>
                </div>
